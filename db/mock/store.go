...
// Source: github.com/kaushikkampli/neobank/db/sqlc (interfaces: Store)
...
// IncrementAccBalance mocks base method.
func (m *MockStore) IncrementAccBalance(arg0 context.Context, arg1 db.IncrementAccBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IncrementAccBalance", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IncrementAccBalance indicates an expected call of IncrementAccBalance.
func (mr *MockStoreMockRecorder) IncrementAccBalance(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncrementAccBalance", reflect.TypeOf((*MockStore)(nil).IncrementAccBalance), arg0, arg1)
}
